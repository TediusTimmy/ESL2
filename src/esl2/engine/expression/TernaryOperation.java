...
public final class TernaryOperation extends Expression
{

    public final Expression condition, thenCase, elseCase;

    public TernaryOperation(Token token, Expression condition, Expression thenCase, Expression elseCase)
    {
        super(token);
    ...
    {
        ValueType COND = condition.evaluate(context);
        ...
        return (true == result) ? thenCase.evaluate(context) : elseCase.evaluate(context);
    }
