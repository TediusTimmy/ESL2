...
public final class NewDictionary extends Statement
{
    ...
    {
        return new FlowControl(FlowControl.Type.RETURN, FlowControl.NO_TARGET, ConstantsSingleton.getInstance().EMPTY_DICTIONARY, token);
    }
