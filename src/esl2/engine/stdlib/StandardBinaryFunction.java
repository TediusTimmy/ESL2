...
public abstract class StandardBinaryFunction extends Statement
{
    ...
    public FlowControl execute(CallingContext context) throws TypedOperationException
    {
        ...
        return new FlowControl(FlowControl.Type.RETURN, FlowControl.NO_TARGET, fun(arg1, arg2), token);
    }

    public abstract ValueType fun(ValueType arg1, ValueType arg2) throws TypedOperationException;
