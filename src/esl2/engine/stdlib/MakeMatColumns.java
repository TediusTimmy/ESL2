...
public final class MakeMatColumns extends StandardTernaryFunction
{
            ...
            if (arg2 instanceof VectorValue)
            {
                if (arg3 instanceof VectorValue)
                {
                    ...
                    return new MatrixValue(new Matrix(
                        src1.value.x, src2.value.x, src3.value.x,
                        src1.value.y, src2.value.y, src3.value.y,
                        src1.value.z, src2.value.z, src3.value.z
                        ));
                }
                else
                {
