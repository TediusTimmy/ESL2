...
public final class MatToQuat extends StandardUnaryFunction
{
    ...
    public ValueType fun(ValueType arg) throws TypedOperationException
    {
        ...
        {
            return new QuaternionValue(new Quaternion(((MatrixValue)arg).value));
        }
        else
        {
            throw new TypedOperationException("Error trying to convert non-Matrix to Quaternion.");
        }
    }
