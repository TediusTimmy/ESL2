...
public final class NewArray extends Statement
{
    ...
    {
        return new FlowControl(FlowControl.Type.RETURN, FlowControl.NO_TARGET, ConstantsSingleton.getInstance().EMPTY_ARRAY, token);
    }
