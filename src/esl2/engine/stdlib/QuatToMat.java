...
public final class QuatToMat extends StandardUnaryFunction
{
    ...
    public ValueType fun(ValueType arg) throws TypedOperationException
    {
        ...
        {
            return new MatrixValue(new Matrix(((QuaternionValue)arg).value));
        }
        else
        {
            throw new TypedOperationException("Error trying to convert non-Quaternion to rotation Matrix.");
        }
    }
