...
public abstract class StandardUnaryFunction extends Statement
{
    ...
    public FlowControl execute(CallingContext context) throws TypedOperationException, FatalException
    {
        ...
        return new FlowControl(FlowControl.Type.RETURN, FlowControl.NO_TARGET, fun(arg), token);
    }

    public abstract ValueType fun(ValueType arg) throws TypedOperationException, FatalException;
