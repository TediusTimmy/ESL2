...
public final class RotVecQuat extends StandardBinaryFunction
{
    ...
    public ValueType fun(ValueType arg1, ValueType arg2) throws TypedOperationException
    {
        if (arg1 instanceof VectorValue)
        {
            ...
            {
                return new VectorValue(((QuaternionValue)arg2).value.rotateVectorAssumeUnit(((VectorValue)arg1).value));
            }
            else
            {
