...
public abstract class StandardTernaryFunction extends Statement
{
    ...
    public FlowControl execute(CallingContext context) throws TypedOperationException
    {
        ...
        return new FlowControl(FlowControl.Type.RETURN, FlowControl.NO_TARGET, fun(arg1, arg2, arg3), token);
    }

    public abstract ValueType fun(ValueType arg1, ValueType arg2, ValueType arg3) throws TypedOperationException;
