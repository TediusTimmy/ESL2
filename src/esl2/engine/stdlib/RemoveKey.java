...
public final class RemoveKey extends StandardBinaryFunction
{
    ...
    public ValueType fun(ValueType arg1, ValueType arg2) throws TypedOperationException
    {
        if (arg1 instanceof DictionaryValue)
        {
            ...
            {
                DictionaryValue result = new DictionaryValue(new TreeMap<ValueType, ValueType>(((DictionaryValue)arg1).value));
                result.value.remove(arg2);
                return result;
            }
            else
            {
        ...
        {
            throw new TypedOperationException("Error trying to remove key from non-Dictionary.");
        }
    }
