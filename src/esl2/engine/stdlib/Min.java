...
public final class Min extends StandardBinaryFunction
{
    ...
    public ValueType fun(ValueType arg1, ValueType arg2) throws TypedOperationException
    {
        if (arg1 instanceof DoubleValue)
        {
            ...
            {
                throw new TypedOperationException("Error computing Min with non-Double second argument.");
            }
        }
        else
        {
            throw new TypedOperationException("Error computing Min with non-Double first argument.");
        }
    }
