...
public final class DebuggerHook extends DebugFunctor
{
    ...
    @Override
    public void EnterDebugger(String message, CallingContext context)
    {
        try
        {
            prop6.engine.CallingContext castedContext = (prop6.engine.CallingContext)context;
            castedContext.fileOut.message("Caught exception: " + message + "\nEntering debugger.");
            EnterDebugger.function(castedContext);
        }
