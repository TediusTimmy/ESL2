...
public final class GetRotationRate_deg_s extends Statement
{

    public GetRotationRate_deg_s()
    {
        super(null);
    }
    ...
    public FlowControl execute(CallingContext context)
    {
        try
        {
            return new FlowControl(FlowControl.Type.RETURN, FlowControl.NO_TARGET,
                new DoubleValue(Math.toDegrees(((prop6.engine.CallingContext)context).settings.earth.rotationRate_rad_s)), token);
        }
