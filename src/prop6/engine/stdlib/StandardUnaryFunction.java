...
public abstract class StandardUnaryFunction extends Statement
{
    ...
    public FlowControl execute(CallingContext context) throws TypedOperationException, FatalException
    {
        try
        {
            ...
            return new FlowControl(FlowControl.Type.RETURN, FlowControl.NO_TARGET, fun((prop6.engine.CallingContext)context, arg), token);
        }
    ...
    public abstract ValueType fun(prop6.engine.CallingContext context, ValueType arg) throws TypedOperationException, FatalException;
