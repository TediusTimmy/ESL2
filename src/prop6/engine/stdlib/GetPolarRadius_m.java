...
public final class GetPolarRadius_m extends Statement
{

    public GetPolarRadius_m()
    {
        super(null);
    }
    ...
    public FlowControl execute(CallingContext context)
    {
        try
        {
            return new FlowControl(FlowControl.Type.RETURN, FlowControl.NO_TARGET, new DoubleValue(((prop6.engine.CallingContext)context).settings.earth.ellipsoid.polarRadius_m), token);
        }
