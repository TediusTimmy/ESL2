...
public final class RealizeNowFirst extends StandardBinaryFunction
{
    ...
    public ValueType fun(CallingContext context, ValueType arg1, ValueType arg2) throws TypedOperationException
    {
        ...
        {
            context.current().pRealizedThisStep.add(((ObjectValue)arg1).value.duplicate());
            context.current().pRealizedThisStep.get(context.current().pRealizedThisStep.size() - 1).realizeArg = arg2;
