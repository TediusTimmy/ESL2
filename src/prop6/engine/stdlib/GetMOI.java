...
public final class GetMOI extends StandardUnaryFunction
{
    ...
    public ValueType fun(ValueType arg) throws TypedOperationException
    {
        ...
        {
            return new MatrixValue(((StateValue)arg).value.MOI);
        }
        else if (arg instanceof ObjectValue)
        {
            return ((ObjectValue)arg).value.variables.get(SimObject.MOI_INDEX);
        }
        else
        {
