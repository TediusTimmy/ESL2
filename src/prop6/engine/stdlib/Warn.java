...
public final class Warn extends StandardUnaryFunction
{
    ...
    public ValueType fun(CallingContext context, ValueType arg) throws TypedOperationException
    {
        if (arg instanceof StringValue)
        {
            ...
            case LOG_WARNING:
                ...
                {
                    context.simulacrum.messages.add(new LogMessage(LogMessageType.LOG_WARNING, ((StringValue)arg).value));
                }
                else
                {
                    context.current().messages.add(new LogMessage(LogMessageType.LOG_WARNING, ((StringValue)arg).value));
                }
                break;
            case LOG_ERROR:
            case LOG_FATAL:
