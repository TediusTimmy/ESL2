...
public final class GetEccentricity extends Statement
{

    public GetEccentricity()
    {
        super(null);
    }
    ...
    public FlowControl execute(CallingContext context)
    {
        try
        {
            return new FlowControl(FlowControl.Type.RETURN, FlowControl.NO_TARGET, new DoubleValue(((prop6.engine.CallingContext)context).settings.earth.ellipsoid.eccentricity), token);
        }
