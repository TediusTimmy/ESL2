...
public final class Error extends StandardUnaryFunction
{
    ...
    public ValueType fun(CallingContext context, ValueType arg) throws TypedOperationException
    {
        if (arg instanceof StringValue)
        {
            ...
            case LOG_ERROR:
                ...
                {
                    context.simulacrum.messages.add(new LogMessage(LogMessageType.LOG_ERROR, ((StringValue)arg).value));
                }
                else
                {
                    context.current().messages.add(new LogMessage(LogMessageType.LOG_ERROR, ((StringValue)arg).value));
                }
                break;
            case LOG_FATAL:
                break;
