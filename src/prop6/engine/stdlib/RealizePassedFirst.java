...
public final class RealizePassedFirst extends StandardBinaryFunction
{
    ...
    public ValueType fun(CallingContext context, ValueType arg1, ValueType arg2) throws TypedOperationException
    {
        ...
        {
            context.current().pRealizePassedThisStep.add(((ObjectValue)arg1).value.duplicate());
            context.current().pRealizePassedThisStep.get(context.current().pRealizePassedThisStep.size() - 1).realizeArg = arg2;
