...
public final class GetVelocityOffsetWRTParent_m_s extends StandardUnaryFunction
{
    ...
    public ValueType fun(ValueType arg) throws TypedOperationException
    {
        ...
        {
            return ((ObjectValue)arg).value.variables.get(SimObject.VELOCITY_OFFSET_INDEX);
        }
        else
        {
