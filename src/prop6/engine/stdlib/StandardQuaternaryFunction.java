...
public abstract class StandardQuaternaryFunction extends Statement
{

    public StandardQuaternaryFunction()
    {
        super(null);
    }
    ...
    public FlowControl execute(CallingContext context) throws TypedOperationException
    {
        try
        {
            ...
            ValueType arg4 = context.currentFrame.args.get(3);
    
            return new FlowControl(FlowControl.Type.RETURN, FlowControl.NO_TARGET, fun((prop6.engine.CallingContext)context, arg1, arg2, arg3, arg4), token);
        }
    ...
    public abstract ValueType fun(prop6.engine.CallingContext context, ValueType arg1, ValueType arg2, ValueType arg3, ValueType arg4) throws TypedOperationException;
