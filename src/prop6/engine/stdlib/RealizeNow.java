...
public final class RealizeNow extends StandardBinaryFunction
{
    ...
    public ValueType fun(CallingContext context, ValueType arg1, ValueType arg2) throws TypedOperationException
    {
        ...
        {
            context.current().realizedThisStep.add(((ObjectValue)arg1).value.duplicate());
            context.current().realizedThisStep.get(context.current().realizedThisStep.size() - 1).realizeArg = arg2;
