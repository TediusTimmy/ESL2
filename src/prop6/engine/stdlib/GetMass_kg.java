...
public final class GetMass_kg extends StandardUnaryFunction
{
    ...
    public ValueType fun(ValueType arg) throws TypedOperationException
    {
        ...
        {
            return new DoubleValue(((StateValue)arg).value.mass_kg);
        }
        else if (arg instanceof ObjectValue)
        {
            return ((ObjectValue)arg).value.variables.get(SimObject.INITIAL_MASS_INDEX);
        }
        else
        {
            throw new TypedOperationException("Error retrieving State value from non-State or Object initial value from non-Object.");
        }
    }
