...
public final class Getg0_m_s2 extends Statement
{
    ...
    public FlowControl execute(CallingContext context)
    {
        try
        {
            return new FlowControl(FlowControl.Type.RETURN, FlowControl.NO_TARGET, new DoubleValue(((prop6.engine.CallingContext)context).settings.earth.g0_m_s), token);
        }
