...
public final class ECIToECR extends StandardBinaryFunction
{
    ...
    public ValueType fun(CallingContext context, ValueType arg1, ValueType arg2) throws TypedOperationException
    {
        if (arg1 instanceof VectorValue)
        {
            ...
            {
                return new VectorValue(context.settings.earth.ECItoECR(((VectorValue)arg1).value, ((DoubleValue)arg2).value));
            }
            else
            {
