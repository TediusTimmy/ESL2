...
public abstract class StandardBinaryFunction extends Statement
{

    public StandardBinaryFunction()
    {
        super(null);
    }
    ...
    public FlowControl execute(CallingContext context) throws TypedOperationException, FatalException
    {
        try
        {
            ...
            return new FlowControl(FlowControl.Type.RETURN, FlowControl.NO_TARGET, fun((prop6.engine.CallingContext)context, arg1, arg2), token);
        }
    ...
    public abstract ValueType fun(prop6.engine.CallingContext context, ValueType arg1, ValueType arg2) throws TypedOperationException, FatalException;
