...
public final class GetEquatorialRadius_m extends Statement
{

    public GetEquatorialRadius_m()
    {
        super(null);
    }
    ...
    public FlowControl execute(CallingContext context)
    {
        try
        {
            return new FlowControl(FlowControl.Type.RETURN, FlowControl.NO_TARGET, new DoubleValue(((prop6.engine.CallingContext)context).settings.earth.ellipsoid.equatorialRadius_m), token);
        }
