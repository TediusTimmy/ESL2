...
public final class GetOrientationOffsetWRTParent_quat extends StandardUnaryFunction
{
    ...
    public ValueType fun(ValueType arg) throws TypedOperationException
    {
        ...
        {
            return ((ObjectValue)arg).value.variables.get(SimObject.ORIENTATION_OFFSET_INDEX);
        }
        else
        {
