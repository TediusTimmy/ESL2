...
public final class Rand extends Statement
{
    ...
    public FlowControl execute(CallingContext context)
    {
        try
        {
            return new FlowControl(FlowControl.Type.RETURN, FlowControl.NO_TARGET, new DoubleValue(((prop6.engine.CallingContext)context).top().myRNG.getNext()), token);
        }
