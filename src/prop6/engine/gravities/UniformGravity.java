...
public final class UniformGravity extends GravityFunctor
{

    @Override
    public Vector getGravityForce(Vector position, double time_s, double mass_kg, Earth earth)
    {
        final double dist = position.magnitude();
        return position.unit().mul(-earth.mu_Nm2_kg * mass_kg / (dist * dist));
    }
