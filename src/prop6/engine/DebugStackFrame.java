...
public class DebugStackFrame extends esl2.engine.DebugStackFrame
{
    ...
    public final SimObject obj;
    public final ObjectFrame objFrame;

    public DebugStackFrame(StackFrame frame, Token callingToken, FrameDebugInfo info, SimObject obj, ObjectFrame objFrame)
    {
